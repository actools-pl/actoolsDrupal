...
**Live:** [feesix.com](https://feesix.com) &nbsp;·&nbsp; [![CI](https://github.com/actools-pl/actoolsDrupal/actions/workflows/lint.yml/badge.svg)](https://github.com/actools-pl/actoolsDrupal/actions/workflows/lint.yml)
...
> **DNS must be configured before install.** Caddy obtains TLS certificates automatically — this requires your domain to resolve to the server IP before the installer runs.
>
> For extra security, add a DNS CAA record at your registrar:
> ```
> CAA 0 issue "letsencrypt.org"
> ```
> This prevents any other CA from issuing certificates for your domain.
