...
# setup_stack starts at line 430, closes at line 750
# setup_cli   starts at line 969, closes at line 984
#
...
readonly SS_START=430  SS_END=750
readonly SC_START=969  SC_END=984
...
capture_variant() {
  ...
  (
    ...
    for _sm in mycnf images caddyfile; do
